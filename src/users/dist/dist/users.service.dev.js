...
function () {
  function UsersService(userModel) {
    ...
    this.updateUserToken = function (refreshToken, _id) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [4
            /*yield*/
            , this.userModel.find(filter).skip(skip).limit(limit).sort(sort).select('-password').populate(population)];
  ...
  UsersService.prototype.findOne = function (id) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            if (mongoose_2['default'].Types.ObjectId.isValid(id) === false) throw new common_1.NotFoundException('not found user');
            return [4
            /*yield*/
            , this.userModel.findOne({
              _id: id
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            , this.userModel.updateOne({
              _id: id
            }, __assign(__assign({}, updateUserDto), {
              updatedBy: {
                _id: user._id,
                name: user.name,
                email: user.email
  ...
  UsersService = __decorate([common_1.Injectable(), __param(0, mongoose_1.InjectModel(user_schema_1.User.name))], UsersService);
  return UsersService;
}();
