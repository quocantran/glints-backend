...
var JwtStrategy = /** @class */ (function (_super) {
    ...
    JwtStrategy.prototype.validate = function (payload) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _id, name, email, role, companyId, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _id = payload._id, name = payload.name, email = payload.email, role = payload.role, companyId = payload.companyId;
                        return [4 /*yield*/, this.roleService.findOne(role._id)];
